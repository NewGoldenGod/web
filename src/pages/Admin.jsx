        ...
        <div className="stats-grid">
          <div className="stat-card">
            <div className="stat-icon">
              <img src="/src/image/folder.png" alt="Activos" />
            </div>
          ...
          <div className="stat-card">
            <div className="stat-icon">
              <img src="/src/image/Checkmark.png" alt="Completados" />
            </div>
            <div className="stat-content">
          ...
          <div className="stat-card">
            <div className="stat-icon">
              <img src="/src/image/YellowCheckMark.png" alt="Grúas" />
            </div>
            <div className="stat-content">
          ...
          <div className="stat-card">
            <div className="stat-icon">
              <img src="/src/image/list.png" alt="Talleres" />
            </div>
            <div className="stat-content">
        ...
        <div className="quick-actions">
          ...
          <div className="action-buttons">
            <Link to="/ingreso" className="action-btn">
              <img src="/src/image/folder.png" alt="Nuevo" className="action-icon" />
            ...
            <Link to="/reporte" className="action-btn">
              <img src="/src/image/Checkmark.png" alt="Reportes" className="action-icon" />
        ...
        <div className="recent-activity">
          ...
          <div className="activity-list">
            <div className="activity-item">
              <img src="/src/image/folder.png" alt="Nuevo" className="activity-icon" />
            ...
            <div className="activity-item">
              <img src="/src/image/list.png" alt="Proceso" className="activity-icon" />
              <div className="activity-content">
            ...
            <div className="activity-item">
              <img src="/src/image/Checkmark.png" alt="Completado" className="activity-icon" />
              <div className="activity-content">
